      ...
      <div className="mb-8 md:flex md:justify-between md:items-center md:px-12">
       ...
       <div className="flex flex-col px-4 md:px-6 md:flex-row md:flex-wrap md:justify-around">
          ...
          <div className='rounded-2xl m-4 overflow-hidden bg-lightBlueBg hover:scale-105 transition-transform duration-300 ease w-auto md:max-w-80'>
            <img src={BitcoinImage} className="w-full h-1/2 transition-transform hover:scale-105" />
          ...
          <div className='rounded-2xl m-4 overflow-hidden bg-lightBlueBg hover:scale-105 transition-transform duration-300 ease min-h-96 w-auto md:max-w-80'>
            <img src={BlackmailExtortion} className="w-full h-1/2 transition-transform hover:scale-105" />
          ...
          <div className='rounded-2xl m-4 overflow-hidden bg-lightBlueBg hover:scale-105 transition-transform duration-300 ease w-auto md:max-w-80'>
            <img src={AccountActivation} className="w-full h-1/2 transition-transform hover:scale-105" />
            <div className="mx-2 my-6 pb-4">
          ...
          <div className='rounded-2xl m-4 overflow-hidden bg-lightBlueBg hover:scale-105 transition-transform duration-300 ease w-auto md:max-w-80'>
            <img src={ScoreRecord} className="w-full h-1/2 transition-transform hover:scale-105" />
            <div className="mx-2 my-6 pb-4">
          ...
          <div className='rounded-2xl m-4 overflow-hidden bg-lightBlueBg hover:scale-105 transition-transform duration-300 ease w-auto md:max-w-80'>
            <img src={DeviceHack} className="w-full h-1/2 transition-transform hover:scale-105" />
            <div className="mx-2 my-6 pb-4">
          ...
          <div className='rounded-2xl m-4 overflow-hidden bg-lightBlueBg hover:scale-105 transition-transform duration-300 ease w-auto md:max-w-80'>
            <img src={Socials} className="w-full h-1/2 transition-transform hover:scale-105" />
            <div className="mx-2 my-6 pb-4">
